export const FuguangTaskRuntimeProtocol = (() => {
  ...
  const MESSAGE = Object.freeze({
    ...
    WAKE_JOB: "FUGUANG_TASK_RUNTIME_WAKE_JOB",
    CANCEL_JOB: "FUGUANG_TASK_RUNTIME_CANCEL_JOB",
    GET_JOB_WORK: "FUGUANG_TASK_RUNTIME_GET_JOB_WORK",
    GET_JOB_EXECUTION_INPUT: "FUGUANG_TASK_RUNTIME_GET_JOB_EXECUTION_INPUT",
    REPORT_JOB_WORK_PROGRESS: "FUGUANG_TASK_RUNTIME_REPORT_JOB_WORK_PROGRESS",
    COMMIT_JOB_WORK_RESULT: "FUGUANG_TASK_RUNTIME_COMMIT_JOB_WORK_RESULT",
